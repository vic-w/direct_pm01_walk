...
6. 加上command，checkpoint：2025-11-02_08-32-08 （exported）
...
We provide an example UI extension that will load upon enabling your extension defined in `source/direct_pm01_walk/direct_pm01_walk/ui_extension_example.py`.
...
```json
{
    "python.analysis.extraPaths": [
        "<path-to-ext-repo>/source/direct_pm01_walk"
    ]
}
```
